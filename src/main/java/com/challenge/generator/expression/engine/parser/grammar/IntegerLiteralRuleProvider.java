...
/**
 * Provides parsing support for integer literal tokens.
 */
@Component
public class IntegerLiteralRuleProvider implements GrammarRuleProvider {
    @Override
    ...
    public TokenParser getTokenParser() {
        return new TokenParser() {
            ...
            public ExpressionNode parsePrefix(ExpressionParser parser, TokenStream stream, Token token) {
                ...
                return new LiteralNode(numericValue, com.challenge.generator.expression.engine.model.DataType.INTEGER, token.position());
            }
        };
    }
}
