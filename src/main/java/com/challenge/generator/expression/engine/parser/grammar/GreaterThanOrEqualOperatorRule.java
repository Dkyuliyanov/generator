...
@Component
public class GreaterThanOrEqualOperatorRule implements GrammarRuleProvider {
    @Override
    ...
    public TokenParser getTokenParser() {
        return new TokenParser() {
            ...
            public ExpressionNode parseInfix(ExpressionParser parser, TokenStream stream, ExpressionNode left, Token token) {
                ...
                return new BinaryOpNode(Operator.GREATER_THAN_OR_EQUAL.getSymbol(), left, right, token.position());
            }
